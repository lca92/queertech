    ...
    <div className="aboutPage">
      <div className="mainAbout">
        <div className="aboutText">
          ...
          <p>
            O projeto <strong>For (queer in tech)</strong> nasce da necessidade
            de um mercado de tecnologia mais diverso. Nós criamos a ponte entre
          ...
          <p>
            ...
            abertamente sobre a própria orientação sexual ou identidade de
            gênero no ambiente profissional". Um ambiente de trabalho seguro
            confere maior produtividade e identificação com a empresa. Além
            disso, se um sistema é homogêneo, seus produtos sempre terão a mesma
            cara. Ao ter pessoas de diferentes realidades e com diferentes
            vivências no corpo da empresa, há mais criatividade e inovação nos
            projetos.
          </p>
          <p>
            A ideia parte de duas colegas do bootcamp de Web Development do
            Ironhack São Paulo, ambas orgulhosamente parte da comunidade
            LGBTQIA+.
          </p>
        </div>
        <div className="profileCards">
          <ProfileCard
            ...
            flag={lesbianFlag}
            bio="Estudante de web dev, paulista, 34 anos"
